...
<template>
    <div class="background">
        <div class="game-background">
            <n-space class="base-info" vertical :size="24">
                <n-card>
                    <n-space :size="24">
                        <n-avatar
                            round
            ...
            <n-space class="next-info" vertical :size="24">
                <n-button type="primary" @click="jumpTo('/software/GameRecords')">
                    对局记录
                </n-button>
                <n-button type="primary" @click="jumpTo('/software/GameSetting')">
                    软件设置
                </n-button>
            </n-space>
        </div>
